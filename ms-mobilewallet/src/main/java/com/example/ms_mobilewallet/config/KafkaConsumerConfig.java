package com.example.ms_mobilewallet.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, BankAccountDTO>> kafkaListenerContainerFactory() {
